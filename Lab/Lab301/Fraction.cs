...
namespace Lab301
{
    ...
    public class Fraction
    {
        ...
        public Fraction(double a, double p2)
        {
            Numer = a / Fraction.GCD(a, p2);
            Denom = p2 / Fraction.GCD(a, p2);
            count++;
        }
        ...
        public static Fraction operator +(Fraction p, int p1)
        {
            return new Fraction(p.Numerator + (p1 * p.Denominator), p.Denominator);
        }
